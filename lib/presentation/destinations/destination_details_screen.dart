...
class _DestinationDetailsScreenState extends State<DestinationDetailsScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    context.read<DestinationBloc>().add(LoadDestinationDetails(destinationId: widget.destinationId));
                          ...
                          children: [
                            Expanded(
                              child: OutlinedButton.icon(
                                onPressed: () {
                                  // Show on map
                                  _tabController.animateTo(4); // Switch to map tab
                                },
                                icon: Icon(Icons.map),
