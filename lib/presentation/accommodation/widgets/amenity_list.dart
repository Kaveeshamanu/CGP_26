...
class AmenityList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, List<String>> categorizedAmenities = _categorizeAmenities();
  ...
  Widget _buildAmenitiesGrid(BuildContext context, List<String> categoryAmenities) {
  ...
  IconData _getAmenityIcon(String amenity) {
    ...
    var door_front = Icons.door_front;
  ...
  Map<String, List<String>> _categorizeAmenities() {
    ...
    final Map<String, List<String>> categoryDefinitions = {
      'Essentials': [
        'Wifi', 'TV', 'Cable TV', 'Air conditioning', 'Heating', 'Fan', 'Iron', 
        'Essentials', 'Towels', 'Bed linens', 'Soap', 'Toilet paper'
      ],
      'Kitchen & Dining': [
        'Kitchen', 'Refrigerator', 'Microwave', 'Dishes and silverware', 
        'Dishwasher', 'Coffee maker', 'Stove', 'Oven', 'BBQ grill', 'Dining table'
      ],
      'Bathroom': [
        'Hot water', 'Shower', 'Bathtub', 'Hair dryer', 'Shampoo', 'Towels'
      ],
      'Bedroom & Laundry': [
        'Washer', 'Dryer', 'Hangers', 'Bed linens', 'Extra pillows and blankets', 
        'Clothing storage'
      ],
      'Entertainment': [
        'Game console', 'Books and reading material', 'Board games', 
        'Sound system', 'TV', 'Cable TV'
      ],
      'Outdoor': [
        'Patio or balcony', 'Garden or backyard', 'Pool', 'Hot tub', 'Beach access',
        'Outdoor furniture', 'Outdoor dining area', 'BBQ grill', 'Free parking',
        'Paid parking'
      ],
      'Workspace': [
        'Dedicated workspace', 'Office supplies', 'Desk', 'Wifi'
      ],
      'Safety': [
      ...
      'Accessibility': [
        'Elevator', 'Step-free entrance', 'Wide doorway', 'Accessible bathroom'
      ],
      'Services': [
        'Breakfast', 'Cleaning before checkout', 'Long term stays allowed',
        '24-hour check-in', 'Self check-in', 'Building staff'
      ],
      'Family': [
        'Crib', 'High chair', 'Children\'s books and toys', 'Children\'s dinnerware'
      ],
      'Other': [
        'Gym', 'EV charger', 'Private entrance', 'Luggage dropoff allowed'
      ],
    };
