...
class Restaurant extends Equatable {
  ...
  Restaurant copyWith({
    ...
    String? chefName,
    List<Map<String, dynamic>>? menuHighlights, required bool isFavorite,
  }) {
    return Restaurant(
      id: id ?? this.id,
      name: name ?? this.name,
    ...
    switch (priceRange.toLowerCase()) {
      ...
      default:
        ...
        try {
          ...
          if (parts.length == 2) {
            final maxPrice = double.parse(parts[1].replaceAll(RegExp(r'[^0-9.]'), ''));
  ...
  String get openingStatus {
    ...
    try {
      ...
      if (currentTime.isBefore(openingTime)) {
        ...
        final displayHour = openingHour > 12 ? openingHour - 12 : (openingHour == 0 ? 12 : openingHour);
