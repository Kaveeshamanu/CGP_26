...
class AccommodationBloc extends Bloc<AccommodationEvent, AccommodationState> {
  ...
  Future<void> _onLoadAccommodationDetails(
    ...
    try {
      ...
      emit(AccommodationsError(message: 'Failed to load accommodation details'));
    }
  }
  ...
  Future<void> _onFilterAccommodations(
    ...
    try {
      ...
      final accommodations = await _accommodationRepository.filterAccommodations(
  ...
  Future<void> _onSearchAccommodations(
    ...
    try {
      ...
      final accommodations = await _accommodationRepository.searchAccommodations(
        query: event.query,
      );
...
extension on AccommodationRepository {
  ...
  Future<List<Accommodation>> searchAccommodations({required String query}) async {
    // Implementation would go here
    return []; // Default implementation
  }
}